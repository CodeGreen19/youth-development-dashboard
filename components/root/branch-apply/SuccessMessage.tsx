...
const SuccessMessage = ({ clear }: { clear: () => void }) => {
  return (
    <div className="flex bg-[#00000039] fixed top-0 left-0 z-30 items-center justify-center h-screen w-full p-4">
      <div className="max-w-lg bg-green-500 p-8 font-bangla rounded-sm">
        <h1> আপনার ফর্ম সফলভাবে জমা হয়েছে।</h1>
        <p className="my-3">
          আমাদের দল দ্বারা পর্যালোচনা শেষে আপনাকে ইমেইলের মাধ্যমে অবহিত করা হবে
          এবং লগইন ইমেইল ও পাসওয়ার্ড প্রদান করা হবে।
        </p>
