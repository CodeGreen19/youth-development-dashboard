      ...
      <Dialog>
        ...
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Detailed information about the selected student is provided below.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-gray-600">
                    <li>
                      <strong>Father&lsquo;s Name:</strong> {student.fatherName}
                    </li>
                    <li>
                      <strong>Mother&lsquo;s Name:</strong> {student.motherName}
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-gray-600">
                    ...
                    <li>
                      <strong>Session Roll:</strong> {student.genRoll || "N/A"}
                    </li>
                    <li>
